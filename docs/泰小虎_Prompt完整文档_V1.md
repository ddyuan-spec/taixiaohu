...
## 五、症状分析Prompt（prompt_symptom_v1.0）
...
## 六、推荐生成Prompt（prompt_recommend_v1.0）
...
## 七、免责声明Prompt（prompt_disclaimer_v1.0）
...
## 八、健康知识问答Prompt（prompt_knowledge_v1.0）
...
## 九、产品咨询Prompt（prompt_product_v1.0）
...
## 十、边界处理Prompt（prompt_boundary_v1.0）
